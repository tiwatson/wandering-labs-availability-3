Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "wandering-labs-availability-3_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = {
    :host => "reserve.wanderinglabs.com",
    :protocol => "https"
  }
  config.action_mailer.asset_host = "https://reserve.wanderinglabs.com"
